...
class QueuesV1QueueUnitTest(base.QueuesTestBase):
    ...
    def test_message_list(self):
        ...
        with mock.patch.object(self.transport, 'send',
            ...
            self.assertIsInstance(msgs, message_iterator._MessageIterator)
    ...
    def test_message_get_many(self):
        ...
        with mock.patch.object(self.transport, 'send',
            ...
            self.assertIsInstance(msg, message_iterator._MessageIterator)
...
class QueuesV1QueueFunctionalTest(base.QueuesTestBase):
    ...
    def test_message_list_functional(self):
        ...
        self.assertTrue(isinstance(messages,
                                   message_iterator._MessageIterator))
